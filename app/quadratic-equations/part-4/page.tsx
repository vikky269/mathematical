import AlmightyFormular from "@/app/components/quadratic/AlmightyFormular"
       ...
       <div className="min-h-screen mt-6 text-gray-800">
          ...
          <AlmightyFormular />
                ...
                <div className="flex justify-between items-center">
                    ...
                    <button className="mt-10">
                        <Link href="/quadratic-equations/part-5" className="mt-6 px-4 py-2 bg-[#76a40b] text-white cursor-pointer rounded-md hover:bg-[#98b05ffb]">
                            Next Lesson
                        </Link>
                    </button>
                </div>
