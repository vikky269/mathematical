...
const SlopeCalculatorWithChart: React.FC = () => {
  ...
  const removePoint = (index: number) => {
    if (points.length <= 2) return; // prevent removing to less than 2 points
        ...
        {points.map((pt, idx) => (
          <div key={idx} className="grid grid-cols-3 gap-4 items-center mb-2">
            ...
            <button
              ...
              className="bg-red-500 text-white px-2 py-1 rounded text-sm disabled:opacity-50 cursor-pointer"
